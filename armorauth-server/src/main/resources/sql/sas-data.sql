...
INSERT INTO `oauth2_client` VALUES ('22aaa0568121584aa983df7a129fe7fd', '4569bca1-bca7-49eb-a03c-7898e9197d5f', '', 'clever', 'none', 'authorization_code,refresh_token', 'http://armorauth-demo:8085/login/oauth2/code/clever','http://armorauth-demo:8085/', '2022-05-06 22:35:11.000000', NULL);
INSERT INTO `oauth2_client` VALUES ('9e6ab3c88d89499a8ae055e5e2e89567', '8ee3a98e-89a8-438d-a314-1ef9df815279', '', 'device', 'none', 'urn:ietf:params:oauth:grant-type:device_code,refresh_token', '','', '2022-05-06 22:35:11.000000', NULL);
...
INSERT INTO `oauth2_scope` VALUES ('8ee3a98e-89a8-438d-a314-1ef9df815279', 'message.read', '读取信息');
INSERT INTO `oauth2_scope` VALUES ('8ee3a98e-89a8-438d-a314-1ef9df815279', 'message.write', '写入信息');
INSERT INTO `oauth2_scope` VALUES ('8ee3a98e-89a8-438d-a314-1ef9df815279', 'userinfo', '用户信息');
...
INSERT INTO `oauth2_client_settings` VALUES ('8ee3a98e-89a8-438d-a314-1ef9df815279', '', b'1', b'0', '');


INSERT INTO `oauth2_token_settings` VALUES ('f62ac251-36d7-42c8-9f75-c31c90111bd4', 300000000000,3600000000000,300000000000,300000000000,'RS256',  b'1', 'self-contained');
INSERT INTO `oauth2_token_settings` VALUES ('8a349006-b8e3-427b-8814-bc4b32e8930a', 300000000000,3600000000000,300000000000,300000000000, 'RS256',  b'1', 'self-contained');
INSERT INTO `oauth2_token_settings` VALUES ('b3d64549-0c6b-4306-9170-886dd8652704', 300000000000,3600000000000,300000000000,300000000000, 'RS256',  b'1', 'self-contained');
INSERT INTO `oauth2_token_settings` VALUES ('4569bca1-bca7-49eb-a03c-7898e9197d5f', 300000000000,3600000000000,300000000000,300000000000, 'RS256',  b'1', 'self-contained');
INSERT INTO `oauth2_token_settings` VALUES ('8ee3a98e-89a8-438d-a314-1ef9df815279', 300000000000,3600000000000,300000000000,300000000000, 'RS256',  b'1', 'self-contained');


INSERT INTO `user_info` VALUES ('0d7c83d900a441c988926af0289de0b2', 'admin', '{bcrypt}$2a$10$9XQTKexOScPtqKGHlKYCrO9IVTXrwE2uxl.aRoVhHrNDoyVVjXHDm', '13103777777', '付林', '2022-05-06 22:35:11', '2022-05-06 22:35:11', 0);
