 ...
 */
package com.armorauth.core.configurers.web;
...
/**
 * Base class for configuring {@link CustomizeAbstractAuthenticationFilterConfigurer}. This is
 * intended for armorauth internal use only.
 *
 ...
 *          built
 * @author fulin
 * @see CaptchaLoginConfigurer
 */
public abstract class CustomizeAbstractAuthenticationFilterConfigurer<B extends HttpSecurityBuilder<B>, T extends CustomizeAbstractAuthenticationFilterConfigurer<B, T, F>, F extends AbstractAuthenticationProcessingFilter>
     ...
     */
    protected CustomizeAbstractAuthenticationFilterConfigurer() {
        setLoginPage("/login");
    }
     ...
     */
    protected CustomizeAbstractAuthenticationFilterConfigurer(F authenticationFilter, String defaultLoginProcessingUrl) {
        this();
     ...
     * Set filter order
     */
    abstract protected void orderFilter(B http, F filter);
    ...
    protected final void updateAccessDefaults(B http) {
        if (this.permitAll) {
            com.armorauth.core.configurers.web.PermitAllSupport.permitAll(http, this.loginPage, this.loginProcessingUrl, this.failureUrl);
        }
    }
