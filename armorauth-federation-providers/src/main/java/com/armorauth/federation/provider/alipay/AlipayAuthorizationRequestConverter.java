...
public class AlipayAuthorizationRequestConverter implements OAuth2AuthorizationRequestConverter {
        ...
        builder.parameters(parameters -> {
            ...
            parameters.forEach((key, value) -> {
                if (OAuth2ParameterNames.CLIENT_ID.equals(key)) {
                    convertedParameters.put("app_id", value);
                } else if (!OAuth2ParameterNames.RESPONSE_TYPE.equals(key)) {
