 ...
 */
package com.armorauth.federation.provider.dingtalk;
...
@Component
public class DingTalkFederatedOAuth2Provider implements FederatedOAuth2Provider {
    ...
    public ClientRegistration.Builder getBuilder(String registrationId) {
        return ExtendedOAuth2ClientProvider.DINGTALK.getBuilder(registrationId);
    }
    ...
    public OAuth2AuthorizationCodeGrantRequestConverter getAuthorizationCodeGrantRequestConverter() {
        return new JsonBodyAuthorizationCodeGrantRequestConverter(
                ExtendedOAuth2ClientProvider.DINGTALK,
                "clientId",
                "clientSecret",
                "grantType"
        );
    ...
    public OAuth2UserService<OAuth2UserRequest, OAuth2User> getOAuth2UserService() {
        return new BearerOAuth2UserService(null);
    }
