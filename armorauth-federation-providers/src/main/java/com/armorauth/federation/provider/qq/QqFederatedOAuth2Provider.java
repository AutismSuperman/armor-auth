...
@Component
public class QqFederatedOAuth2Provider implements FederatedOAuth2Provider {
    ...
    public ClientRegistration.Builder getBuilder(String registrationId) {
        return ExtendedOAuth2ClientProvider.QQ.getBuilder(registrationId);
    }

    @Override
    public OAuth2AuthorizationCodeGrantRequestConverter getAuthorizationCodeGrantRequestConverter() {
        return new QqOAuth2AuthorizationCodeGrantRequestConverter();
    }

    @Override
    public OAuth2AccessTokenRestTemplate getAccessTokenRestTemplate() {
        return new QqAccessTokenRestTemplate();
    }
