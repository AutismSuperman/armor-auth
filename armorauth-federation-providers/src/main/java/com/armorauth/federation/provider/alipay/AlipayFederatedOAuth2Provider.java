...
@Component
public class AlipayFederatedOAuth2Provider implements FederatedOAuth2Provider {
    ...
    public ClientRegistration.Builder getBuilder(String registrationId) {
        return ExtendedOAuth2ClientProvider.ALIPAY.getBuilder(registrationId);
    }

    @Override
    public OAuth2AuthorizationRequestConverter getAuthorizationRequestConverter() {
        return new AlipayAuthorizationRequestConverter();
    }

    @Override
    public OAuth2AuthorizationCodeGrantRequestConverter getAuthorizationCodeGrantRequestConverter() {
        return new AlipayAuthorizationCodeGrantRequestConverter();
    }

    @Override
    public OAuth2AccessTokenRestTemplate getAccessTokenRestTemplate() {
        return new AlipayAccessTokenRestTemplate();
    }

    @Override
    public OAuth2UserService<OAuth2UserRequest, OAuth2User> getOAuth2UserService() {
        return new AlipayOAuth2UserService();
    }
