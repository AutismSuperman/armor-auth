...
public class FederatedOidcAuthorizationCodeAuthenticationProvider implements AuthenticationProvider {
	...
	/**
	 * Constructs an {@code FederatedOidcAuthorizationCodeAuthenticationProvider} using the
	 * provided parameters.
	 ...
	 */
	public FederatedOidcAuthorizationCodeAuthenticationProvider(
