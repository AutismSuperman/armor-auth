...
public interface FederatedOAuth2Provider {

    String getProviderId();

    ClientRegistration.Builder getBuilder(String registrationId);

    default OAuth2AuthorizationRequestConverter getAuthorizationRequestConverter() {
        return null;
    }

    default OAuth2AuthorizationCodeGrantRequestConverter getAuthorizationCodeGrantRequestConverter() {
        return null;
    }

    default OAuth2AccessTokenRestTemplate getAccessTokenRestTemplate() {
        return null;
    }

    default OAuth2UserService<OAuth2UserRequest, OAuth2User> getOAuth2UserService() {
        return null;
    }
