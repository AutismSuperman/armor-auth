...
/**
 * 默认情况下Spring Security会生成授权链接 <br/>
 * {@code https://open.weixin.qq.com/connect/qrconnect?response_type=code&client_id=CLIENT_ID&scope=snsapi_userinfo&state=STATE&redirect_uri=REDIRECT_URI}
 * <br/>
